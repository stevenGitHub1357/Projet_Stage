...
const SyntheseFNC_FAC =({MenuCollapse,theme,logo,cible})=>{
    ...
    async function getData(){
        await axios.get(Url+"/getFNCSynthese").then(res=>{
            if(res.data.length){
                    ...
                    <tbody className={!theme ? "text-dark" : "text-white"}>
                        ...
                        <tr>
                            ...
                            
                            {
                                syntheseListe.map((synthese, index) => (
                                    <form action="">
                                        <input type="text" defaultValue={synthese.commentaire}></input>
                                    </form>
                                ))
                            }
...
export default SyntheseFNC_FAC;